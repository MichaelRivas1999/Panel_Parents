...
{
    public partial class GrupoClaseMaestros : Form
    {
        public GrupoClaseMaestros()
        {
            InitializeComponent();
        }

        private void GrupoClaseMaestros_Load(object sender, EventArgs e)
        {
        ...
        private void EstilizarEncabezado()
        {
            ...
            Dg_GrpuClase.BackgroundColor = Color.White;

            Dg_GrpuClase.ColumnHeadersDefaultCellStyle = columnHeaderStyle;
        }
    }
}
